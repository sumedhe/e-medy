...
public class AdmissionController extends AnchorPane implements Tabular {
	...
	public void setHandlers() {
		...
		deleteButton.setOnAction(e -> {
			ButtonType result = Tool.showConfirmation(String.format("Do you want to delete the admission of %s?", getSelected().getPatient()),
					"Delete");
		...
		dischargeButton.setOnAction(e -> {
			...
			if (a != null && !a.getIsDischarged()){
				if ( Tool.showConfirmation("Do you want to discharge " + a.getPatient().getName() + "?", "Discharge") == ButtonType.YES){
	...
	public void configTable() {
		String[][] colNames = { { "Date", "admittedOn" }, { "Patient", "patient" },
				...
				{ "Discharged", "Discharged" }, { "Discharged On", "dischargedOn" } };
